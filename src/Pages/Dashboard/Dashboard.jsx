...
const Dashboard = () => {
    ...
    const linkStyle = `flex items-center gap-2 px-3 py-2 rounded transition duration-200 ${
            ...
            <aside className={`w-64 ${darkMode ? 'bg-gray-800' : 'bg-blue-800'} text-white p-4`}>
                ...
                <div className="mt-8">
                    <button
                        ...
                        className={`w-full flex items-center justify-center gap-2 px-3 py-2 rounded font-semibold transition duration-200 ${
                            darkMode
